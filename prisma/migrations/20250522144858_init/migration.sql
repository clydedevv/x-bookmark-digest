...
-- CreateIndex
CREATE UNIQUE INDEX "DigestItem_digestId_bookmarkId_key" ON "DigestItem"("digestId", "bookmarkId");
...
-- AddForeignKey
ALTER TABLE "DigestItem" ADD CONSTRAINT "DigestItem_bookmarkId_fkey" FOREIGN KEY ("bookmarkId") REFERENCES "Bookmark"("id") ON DELETE CASCADE ON UPDATE CASCADE;
